        ...
        <div class="min-h-screen flex items-center justify-center">
            <div class="flex flex-col justify-around h-full">
                <div class="text-center">
                    <h1 class="text-grey-darker text-center font-thin text-5xl mb-6">
                        Laravel Elites
                    ...
                    <p class="pb-8">Do you have what it takes to join the inner circle?</p>

                    @guest
                        <a href="/login/github" class="bg-orange-dark hover:bg-orange-darker text-white font-bold py-2 px-4 rounded-full">
